...
export class ClippyManager {
    constructor() {
        ...
        this.tips = [
            '<p class="welcome-text">Hola, soy el asistente de ZarateXP.</p><p class="subtitle">Abre Ruta Reclutador si quieres evaluar CV, proyectos y contacto en pocos clicks.</p>',
