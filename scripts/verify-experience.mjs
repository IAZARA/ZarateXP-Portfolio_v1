...
const checks = [
  ...
  ['nine verified credentials', /Google AI Professional Certificate[\s\S]*Fundamentos de la gestión de proyectos[\s\S]*Google Data Analytics Professional Certificate[\s\S]*ArcGIS Pro Flujos de Trabajo[\s\S]*Operador de Drones en ArcGIS/],
