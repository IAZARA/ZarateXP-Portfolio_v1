...
const requiredReferences = [
  ...
  ['optimized social image', index, /zaratexp-social-ai-architect\.jpg/],
  ['desktop WebP image-set', desktopCss, /zaratexp-hd-wallpaper\.webp/],
  ['coast wallpaper WebP background', appsCss, /wallpapers\/xp-coast\.webp/],
  ['desert wallpaper WebP background', appsCss, /wallpapers\/xp-desert\.webp/],
  ...
  ['ForzaTask optimized project assets', projects, /forzatask-icon\.webp[\s\S]*forzatask-banner\.webp/],
  ['Araña Web optimized project assets', projects, /arana-web-icon\.webp[\s\S]*arana-web-pipeline\.webp/],
...
const sizeBudgets = [
  ...
  ['assets/images/wallpapers/xp-coast.webp', 180 * 1024],
  ['assets/images/wallpapers/xp-desert.webp', 100 * 1024],
  ['logo_ivanxp.webp', 60 * 1024],
  ['assets/readme/zaratexp-social-ai-architect.jpg', 320 * 1024],
  ...
  ['assets/images/project-icons/forzatask-icon.webp', 50 * 1024],
